      ...
      <div className={`${styles.paddingX} mx-auto max-w-7xl`}>
        <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
          <div className="flex flex-col items-center sm:items-start">
            <h4 className="text-[20px] font-bold text-white">Mahmoud Nagy</h4>
          ...
          <div className="flex flex-col items-center sm:items-end">
            ...
            <p className="text-secondary mt-4 text-[14px]">
              © {new Date().getFullYear()} Mahmoud Nagy. All rights reserved.
            </p>
          </div>
        </div>
      </div>
